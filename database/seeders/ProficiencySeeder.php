...
class ProficiencySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $proficiencies = [
            ...
            // Medicine
            ['subject_id' => 3, 'index' => 0, 'name' => 'Elementary', 'description' => 'Very simple, child-friendly explanations of basic health and the human body. Uses everyday examples, no technical terms.'],
            ['subject_id' => 3, 'index' => 1, 'name' => 'High School', 'description' => 'Basic anatomy, physiology, and medical literacy. Easy-to-read content.'],
            ['subject_id' => 3, 'index' => 2, 'name' => 'College', 'description' => 'Pre-medical level understanding, introduces pathophysiology and pharmacology basics.'],
