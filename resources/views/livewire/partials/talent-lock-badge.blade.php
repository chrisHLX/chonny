...
--}}
<span class="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-surface-0 flex items-center justify-center ring-2 ring-surface-1">
    <svg class="w-2.5 h-2.5 text-ink-subtle" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
