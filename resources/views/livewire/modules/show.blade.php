<div class="min-h-full py-8 px-6 lg:px-10">
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        {{-- Spells reference — always live, never stored content (see ModuleSpellReferenceService
             ...
             it, computed fresh from the current game data on every load. Markup lives in
             <x-spells.table>, shared with the public class/spec Spell Explorer page
             (SpellExplorer.php) so both stay visually identical without duplicating ~130 lines. --}}
        <x-spells.table
            :entries="$this->moduleSpellReferences"
            description="Full detail for every ability named in this guide, plus what modifies or enhances each one — pulled live from the current game data, not frozen at authoring time."
        />
